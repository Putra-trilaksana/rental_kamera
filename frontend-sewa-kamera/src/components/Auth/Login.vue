    ...
    <div class="containe">
        <div class="loginPage d-flex">
            ...
            <div class="p-5 loginItem">
                <h1 class="d-flex col-12 justify-content-start pb-2">Login</h1>
                <p class="d-flex col-12 justify-content-start">Pilih Peralatan yang Kamu Suka</p>
                <form action="" @submit="onSubmit" class="position-absolute col-10 mt-5">
                    <div>
                        <div class="mb-3">
                            <label for="username_input" class="fs-6 fw-semibold">Email Address</label>
                            <input 
                                type="email" 
                            ...
                            <div class="m-0 mb-2">
                                <label for="password_input" class="fs-6 fw-semibold">Password</label>
                                <input 
                                type="password" 
                                class="form-control form"
                                id="password_input"
                        ...
                        <button class="btn btn-primary col-12 p-2 fw-bold mt-2" type="submit">Login</button>
                        <div class="register">
